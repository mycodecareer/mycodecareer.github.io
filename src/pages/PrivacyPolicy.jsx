  ...
  return (
    <Layout>
      <section className="flex flex-col justify-start items-start gap-4 mt-36 sm:gap-12 lg:mt-48">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Matthew Sevey Consulting LLC, 53 Old
              Elm St, North Billerica, MA 01862.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to MyCodeCareer, accessible from{" "}
              <a
        ...
        <ul>
          <li>By email: hello@mycodecareer.com</li>
        </ul>
      </section>
    </Layout>
  );
